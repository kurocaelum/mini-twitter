export default function LoginTabButtons({activeTab, setActiveTab}: {activeTab: number, setActiveTab: (tab: number) => void}) {
    const inactiveStyle = "border-b py-2 border-b-gray/20 text-gray font-bold cursor-pointer outline-blue";
    const activeStyle = "border-b-[3px] py-2 border-blue text-blue font-bold cursor-pointer outline-blue";
